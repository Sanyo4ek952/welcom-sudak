...
export function FilterListingsForm({ filters, categories, districts }: FilterListingsFormProps) {
  ...
  return (
    <form className="glass-card grid gap-3 rounded-3xl p-5 md:grid-cols-2 lg:grid-cols-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <Link className="inline-flex rounded-full px-3 py-2 text-sm text-slate-700 hover:bg-white/70" href="/listings">
          Сбросить
        </Link>
      </div>
    </form>
