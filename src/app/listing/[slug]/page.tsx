      ...
      <div className="grid gap-6 lg:grid-cols-[2fr_1fr]">
        ...
        <div className="space-y-4">
          <Card className="space-y-2 p-4">
            <h2 className="text-lg font-semibold text-slate-900">Ключевая информация</h2>
          ...
          <Card className="space-y-2 p-4">
            ...
            {listing.websiteUrl ? (
              <a className="block text-sm text-sky-700 hover:text-sky-800" href={listing.websiteUrl} target="_blank" rel="noreferrer">
                Сайт
              </a>
            ) : null}
            {listing.instagramUrl ? (
              <a className="block text-sm text-sky-700 hover:text-sky-800" href={listing.instagramUrl} target="_blank" rel="noreferrer">
                Instagram
              </a>
            ) : null}
            {listing.telegramUrl ? (
              <a className="block text-sm text-sky-700 hover:text-sky-800" href={listing.telegramUrl} target="_blank" rel="noreferrer">
                Telegram
              </a>
            ) : null}
            {listing.whatsappUrl ? (
              <a className="block text-sm text-sky-700 hover:text-sky-800" href={listing.whatsappUrl} target="_blank" rel="noreferrer">
                WhatsApp
              </a>
            ) : null}
